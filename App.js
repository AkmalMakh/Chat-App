// @refresh reset
import {Button, Header} from './src/components/comman';
...
export default function App() {
  ...
  async function handlePress() {  // creating user 
      const _id = Math.random().toString(36).substring(7)
      const user = { _id, name }
      await AsyncStorage.setItem('user', JSON.stringify(user))
      setUser(user)
  }
  async function handleSend(messages) { ///reading all messages and displaying
